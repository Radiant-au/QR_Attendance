...
router.get("/", authenticateUserToken, activityController.getAllActivities);
router.get("/:id/attendance", authenticateAdminToken, activityController.getActivityAttendanceRegistraion);
router.patch("/status/change", authenticateAdminToken, validateBody(UpdateActivityStatusDTO), activityController.updateActivityStatus);
